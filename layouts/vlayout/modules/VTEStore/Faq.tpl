            ...
            <div name="massEditContent" style="overflow: hidden; width: auto; height: auto;">
                <div class="modal-body tabbable">
                    ...
                    <div class="tab-content massEditContent">
                        ...
                        <div id="block_2" class="tab-pane" align="center"><img src="https://www.vtexperts.com/guides/guide2.png"></div>
                        <div id="block_3" class="tab-pane" style="max-height: 500px; overflow-y: scroll;">{$USABILITY}</div>
                        <div id="block_4" class="tab-pane" style="max-height: 500px; overflow-y: scroll;">{$SUBSCRIPTION_HELP}</div>
                        <div id="block_5" class="tab-pane" style="max-height: 500px; overflow-y: scroll;">{$TROUBLESHOOTING}</div>
                    </div>
                </div>
            </div>
        </div>
