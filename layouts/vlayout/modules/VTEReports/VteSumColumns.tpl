                        ...
                        <div class="row-fluid padding1per" style="margin-left: 20%">
                            <div class="span8">
                                <div style="height:40px;">
                                    ...
                                    <input type="text" id="search_input_sum" class="span3" onkeyup="getSUMFieldsOptionsSearch(this)" placeholder="{vtranslate('LBL_Search_column',$MODULE)}" style="height: 38px;margin-left: 16px;">
                                </div>
                            </div>
                            ...
                            <div class="span12" id="div_selected_column">
                            </div>
                    </td>
                </tr>
                <tbody>
