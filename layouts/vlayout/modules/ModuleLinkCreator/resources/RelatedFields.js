...
jQuery(document).ready(function () {
    ...
    jQuery(document).on('click', '[type="submit"]', {}, function () {
        ...
        var dataUrl = "index.php?module=" + app.getModuleName() + "&action=ActionAjax&mode=saveRelatedFields&module1=" + sltModule1.val()
            + "&module2=" + sltModule2.val() + "&field_label=" + txtFieldLabel.val() + "&block=" + sltBlock.val() + "&related_list_label=" + txtRelatedListLabel.val() + "&action_select=" + boleanActionSelect + "&action_add=" + boleanActionAdd;
        AppConnector.request(dataUrl).then(
            function (data) {
                if (data.success) {
