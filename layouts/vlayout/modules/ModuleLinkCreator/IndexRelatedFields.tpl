        ...
        <form class="form-horizontal" method="post" action="index.php" onsubmit="return false;">
            ...
            <table class="table table-bordered blockContainer showInlineTable equalSplit">
                ...
                <tr>
                    ...
                    <td class="fieldValue medium">
                        <div class="row-fluid">
                            {*<span><input type="checkbox" id = "action_select" name="action_select"> Allow to Select</span><br>*}
                            <span><input type="checkbox" id ="action_add" name="action_add"> Allow to Add New</span>
                            {*<select name="add_related_list" id="add_related" class="select2 span10">*}
                                {*<option value="-">{vtranslate('LBL_SELECT', $MODULE)}</option>*}
