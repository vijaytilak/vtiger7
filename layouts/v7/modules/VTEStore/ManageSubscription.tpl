...
<div class='modal-dialog modal-lg'>
    <div class="modal-header contentsBackground">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true" {if $CHARGIFY_CUSTOMER_ID==0 || $CHARGIFY_CUSTOMER_ID==''}onclick="{literal}app.helper.showSuccessNotification({message: app.vtranslate('JS_PLEASE_WAIT')}); reloadCurrentPage();{/literal}"{/if}>&times;</button>
