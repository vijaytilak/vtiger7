                    ...
                    {if in_array($MODULE_DETAIL->module_name,$VTMODULES)}
                        ...
                        <div class="dropdown" style="display: inline-block;">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="divider"></li>
                                <li class="oneclickRegenerateLicense" data-message="{vtranslate('LBL_MESSAGE_REGENERATE_LICENSE', 'VTEStore')}"><a href="javascript: void(0);">{vtranslate('LBL_REGENERATE_LICENSE', 'VTEStore')}</a></li>
                            </ul>
                        </div>&nbsp;&nbsp;
