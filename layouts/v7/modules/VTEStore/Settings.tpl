    ...
    <div class="widget_header row-fluid">
        <table width="100%">
            ...
            {if $USE_CUSTOM_HEADER>0}
                <td><a href="index.php?module=VTEStore&parent=Settings&view=Settings&reset=1"><h5 style="font-weight: bold; font-size: 20px;">{vtranslate('MODULE_LBL_CUSTOM', 'VTEStore')}</h5></a></td>
                <td style="float: right">{include file='HeaderStoreCustom.tpl'|@vtemplate_path:'VTEStore'}</td>
            {else}
                <td><a href="index.php?module=VTEStore&parent=Settings&view=Settings&reset=1"><h5 style="font-weight: bold; font-size: 20px;">{vtranslate('MODULE_LBL', 'VTEStore')}</h5></a></td>
