                ...
                <div name="massEditContent" style="overflow: hidden; width: auto; height: auto;">
                    <div class="modal-body tabbable">
                        ...
                        <div class="summaryWidgetContainer" style="border:1px solid #ccc;">
                            ...
                            <div class="summaryWidgetContainer" style="width:45%; height:220px;border:1px solid #ccc;margin: 20px 19px 0 0; float: left; font-size: 11px;">
                                ...
                                {if $VTVERSION=='vt7'}<br>Folder layouts/v7/modules: {if $MESSAGES.layouts_v7_modules==1}<font color="green">OK</font>{else}<font color="red">{vtranslate('Insufficient permissions', 'VTEStore')}</font> <a href="https://www.vtexperts.com/vtiger-extension-insufficient-permissions/" target="_blank" style="text-decoration: underline!important;"> {vtranslate('LBL_MORE_DETAILS', 'VTEStore')}</a>{/if}{/if}
                            ...
                            <div class="summaryWidgetContainer" style="width:48%; height:220px;border:1px solid #ccc;margin: 20px 0px 0 0; float: left; font-size: 11px;">
