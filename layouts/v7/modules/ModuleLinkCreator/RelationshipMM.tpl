        ...
        <form class="form-horizontal fieldBlockContainer" method="post" action="index.php" onsubmit="return false;">
            <div class="contentHeader row">
                <h3 class="col-sm-8 col-xs-8 textOverflowEllipsis"
                    title="{vtranslate('add_new_related_field_explain', $MODULE)}">{vtranslate('LBL_CREATEING_MM', $MODULE)}</h3>
            ...
            <div class="contentHeader row-fluid">
                <div class="alert alert-warning">{vtranslate('noticeMM', $MODULE)}</div>
            </div>
            <table class="table table-bordered listview-table" style="border-top: 1px solid #ddd;">
                <thead>
                <tr>
                    <th colspan="4">{vtranslate('add_new_related_field_MM', $MODULE)}</th>
                </tr>
                </thead>
                <tbody>
                <tr>
                ...
                <tr>
                    <td class="fieldLabel medium">
                        <label class="muted pull-right marginRight10px">{vtranslate('related_Module12', $MODULE)}</label>
                    </td>
                    <td class="fieldValue medium">
                        <div class="row-fluid">
                ...
                <tr>
                    <td class="fieldLabel medium">
                        <label class="muted pull-right marginRight10px">{vtranslate('related_Module21', $MODULE)}</label>
                    </td>
                    <td class="fieldValue medium">
                        <div class="row-fluid">
            ...
            <div class="row-fluid">
                <div class="pull-right">
                    <button id="add_related_label" class="btn btn-success" type="submit">
                        <strong>{vtranslate('LBL_SAVE', $MODULE)}</strong>
                    </button>
                    <a class="cancelLink" href="index.php?module={$MODULE}&view=List">{vtranslate('LBL_CANCEL', $MODULE)}</a>
                </div>
