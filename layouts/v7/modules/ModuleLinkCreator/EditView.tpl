...
<div class="main-container">
    ...
    <div class="col-sm-12 col-xs-12 content-area">
        ...
        <form class="form-horizontal fieldBlockContainer" id="EditView" name="EditView" method="post" action="index.php"
            ...
            <table id="module-link-creator-edit-table" class="table table-bordered listview-table" style="border-top: 1px solid #ddd;">
                <thead>
                <tr>
