...
* ****************************************************************************** */*}
{strip}
    <div class="editContainer" style="border:1px solid #ccc;padding:2%;">
        <h3>
        ...
        <div class="editContainer" style="border:1px solid #ccc;padding:2%;">
            <div class="padding1per">
                <div class="row" style="margin-bottom:10px;">
                    <span class="col-lg-2" style="text-align: right"><strong>{vtranslate('LBL_VTIGER_URL',$QUALIFIED_MODULE)}</strong></span>
                    <span class="col-lg-6">{$LICENSE_INFO['site_url']}</span>
                </div>
                <div class="row" style="margin-bottom:10px;">
                    <span class="col-lg-2" style="text-align: right"><strong>{vtranslate('LBL_LICENSE_KEY',$QUALIFIED_MODULE)}</strong></span>
                    <span class="col-lg-6">{$LICENSE_INFO['license']}</span>
                </div>
                <div class="row" style="margin-bottom:10px;">
                    <span class="col-lg-2" style="text-align: right"><strong>{vtranslate('LBL_LICENSE_EXPIRES',$QUALIFIED_MODULE)}</strong></span>
                    <span class="col-lg-6">{$LICENSE_EXPIRES}</span>
                </div>
                <div class="row" style="margin-bottom:10px;">
                    <span class="col-lg-2" style="text-align: right"><strong>{vtranslate('LBL_SUPPORT_EXPIRES',$QUALIFIED_MODULE)}</strong></span>
                    <span class="col-lg-6">{$SUPPORT_EXPIRES}</span>
                </div>
