 ...
 ********************************************************************************/
-->*/*}
<script language="JAVASCRIPT" type="text/javascript" src="layouts/v7/modules/VTEReports/resources/VTEReports.js"></script>
{$DATE_FORMAT}
...
.table-report select,.box-group .select2-container,.box-group .select2-container .select2-choice,.crmTable select[name*="fcon"],.select2-container,.select2{
...
.conditionRow .select2-container .select2-choice,.conditionRow .select2-container .select2-choice,.select2-container .select2-chosen{
    background-color: #ccc!important;
...
.select-style select.repBox {
    font-size:13px;
}
.select2-arrow{
    display: none!important;
}
.table-report input[type="radio"],.table-report input[type="checkbox"]{
    padding: 0px;
}
...
.div_column_child_off{
    background: -webkit-linear-gradient(left, #ddd 0, #ddd 24%, transparent 15%);
...
.div_column_child_off:hover,.div_column_child_on{
    background: -webkit-linear-gradient(left, #1998cb 0, #1998cb 24%, transparent 15%);
...
.select-style,span.select2-chosen{
...
.table-report .chzn-container-single, .table-report .chzn-container-single .chzn-single,.table-report .select2-choice,.crmTable select[name*="fcon"]{
    background-color: #ccc!important;
}
.table-report .chzn-container-single .chzn-single,.table-report .select2-choice,select.gpcon-select {
    background: #ccc url("./modules/VTEReports/img/select-icon.png") no-repeat 90% 50%;
    border: medium none;
}
.table-report .chzn-container-single .chzn-single div,.table-report .select2-choice div,.crmTable .select2-arrow{
    display: none;
}
.table-report .chzn-drop .chzn-search input,input.select2-input {
    width: 100%!important;
}
.select-style select {
    padding: 5px 8px;
...
select[name*="fcon"] ,select[name*="gpcon"]{
    max-width: 100%!important;
    text-indent: 47%;
    font-size: 15px!important;
}
div[id*="id_s_fval"],div[id*="selectedRecipients"]{
     padding: 0px!important;
}
input[id*="fval"],div[id*="id_s_fval"]{
