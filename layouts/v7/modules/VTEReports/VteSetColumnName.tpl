...
<div class="row-fluid">
    <div class="span12">
        <div class="row-fluid">
            ...
            <input type="hidden" name="labels_to_highlights" id="labels_to_highlights" value="">
                        ...
                        <tr style="height:25px" class="drag_to_sort_order" data-id="{$fieldinput['input_name']}">
                            ...
                            {if $REPORT_TYPE == "tabular"}
                                ...
                                <td class="dvtCellInfo" align="center" colspan="1">
                                    <input type="checkbox" class="v_highlight" name="{$input_name}_highlight" {$fieldinput['is_highlight']} >
                                </td>
