...
<style>
    ...
    .box-group .select2-container .select2-choice,.conditionRow .select2-container .select2-choice,.select2-container .select2-chosen,.select-style .select2,.crmTable select[name*="fcon"]{
        background-color: #ccc!important;
    ...
    .select2-container,input.repBox{
        font-size: 13px!important;
    }
    select[name*="fop"]{
        font-size: 13px!important;
...
{strip}
    ...
    <div class="container-fluid no-print">
        <div class="row-fluid reportsDetailHeader">
            ...
            <br>
            <div class="reportHeader row-fluid" style="text-align: center;">
                <table width="100%">
                    <tr>
                        <td>
                                ...
                                <span class="pull-right">
                                    <div class="btn-toolbar">
                                        {foreach item=DETAILVIEW_LINK name=LINK from=$DETAILVIEW_LINKS}
                                            ...
                                            <div class="btn-group">
                                                <button class="btn" name="{$LINKNAME}" data-href="{$DETAILVIEW_LINK->getUrl()}" {if $DETAILVIEW_LINK->get('id')!=""}id="{$DETAILVIEW_LINK->get('id')}"{/if} {if $DETAILVIEW_LINK->get('style')!=""}style="{$DETAILVIEW_LINK->get('style')}"{/if} {if $DETAILVIEW_LINK->get('onClick')!=""}onClick="{$DETAILVIEW_LINK->get('onClick')}"{/if} >
...
{* ADVANCE FILTER END *}
                <div class="row-fluid">
                    <div class="textAlignCenter">
                        <button class="btn generateReport" id="generateReportNow" data-mode="generate" value="{vtranslate('LBL_GENERATE_NOW',$MODULE)}"/>
                        ...
                        {/if}
                        <input type="hidden" id="is_loaded" value="0" />
                   </div>
                </div>
				<br>
            </div>
...
<script>
    jQuery(document).ready(function () {
        ...
        jQuery('#CSVExport').click(function(e){
            var element = jQuery(e.currentTarget);
            var href = element.data('href');
            window.location = href;
            return false;
