...
VTEReports_Detail_Js("VTEReports_ChartDetail_Js",{
	...
	registerEventForChartGeneration : function() {
		...
		try {
			...
			console.log("error");
			console.log(error);
			VTEReport_ChartDetail_Js.displayNoDataMessage();
			return;
		}
	},
	...
	registerEvents : function(){
		...
		VTEReports_ChartEdit3_Js.registerFieldForChosen();
		VTEReports_ChartEdit3_Js.initSelectValues();
...
Vtiger_Pie_Widget_Js('Report_Piechart_Js',{},{
	...
	postLoadWidget : function() {
		if(!VTEReport_ChartDetail_Js.isEmptyData()) {
			this.loadChart();
		}else{
