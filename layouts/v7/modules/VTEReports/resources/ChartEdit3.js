 ...
 * All Rights Reserved.
 *************************************************************************************/
VTEReports_Edit3_Js("VTEReports_ChartEdit3_Js",{

	registerFieldForChosen : function() {
        vtUtils.applyFieldElementsView(jQuery('#groupbyfield'), 'select2');
        vtUtils.applyFieldElementsView(jQuery('#datafields'), 'select2');
	},
	...
	registerEvents : function(){
		...
		VTEReport_ChartEdit3_Js.registerFieldForChosen();
		VTEReport_ChartEdit3_Js.initSelectValues();
	}
});