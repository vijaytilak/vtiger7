    ...
    <tbody> 
                    ...
                    <div class="row-fluid span12">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <div style="margin-left: 56px;margin-right: 30px;float: left;width: 60px;">
            ...
            <tr>
                <td class="fieldLabel medium" style="vertical-align: text-bottom;">
                    <label class="pull-right marginRight10px" style="margin-top: 6px;">{vtranslate("Recipients",$MODULE)}</label>
                </td>
                <td>
                    <table>
                        <tr>
                            ...
                            <td>
                                <table style="width: 166px;margin-left: 10px;">
...
<script>
    jQuery('.scheduled-div').on('click',function(){
