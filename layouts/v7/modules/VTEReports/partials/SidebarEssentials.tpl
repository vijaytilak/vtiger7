		...
		<div class="module-filters" id="module-filters">
			<div class="sidebar-container lists-menu-container">
				<div class="sidebar-header clearfix">
					...
					{*<button id="createFilter" onclick='VTEReports_List_Js.triggerAddFolder("index.php?module=Reports&view=EditFolder");' class="btn btn-default pull-right sidebar-btn" title="{vtranslate('LBL_ADD_NEW_FOLDER', $MODULE)}">*}
						{*<div class="fa fa-plus" aria-hidden="true"></div>*}
					{*</button> *}
				</div>
				<hr>
				<div>
					<input class="search-list" type="text" placeholder="{vtranslate('Search folder',$MODULE)}">
				</div>
								...
								<div class="list-group">
									<ul class="lists-menu">
										<li style="font-size:12px;" class="listViewFilter" >
											<a href="#" class='filterName vteViewByFolder' data-filter-id="All"><i class="fa fa-folder foldericon"></i>&nbsp;{vtranslate('LBL_ALL_REPORTS', $MODULE)}</a>
										</li>
										{foreach item=FOLDER from=$FOLDERS name="folderview"}
											<li style="font-size:12px;" class="listViewFilter {if $smarty.foreach.folderview.iteration gt 5} filterHidden hide{/if}" >
												...
												<a href="#" class='filterName vteViewByFolder' data-filter-id={$FOLDER->getId()}><i class="fa fa-folder foldericon"></i>&nbsp;{if {$VIEWNAME|strlen > 50} }{$VIEWNAME|substr:0:45}..{else}{$VIEWNAME}{/if}</a>
