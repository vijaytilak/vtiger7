...
<div class="col-lg-{$COLS} marginTop10px">
    <div class="panel panel-default" style="border: 1px solid {$OVERDUE_BORDER_COLOR}; border-left: 20px solid {$OVERDUE_BORDER_COLOR};">
        <div class="panel-body">
            <div class="row">
                <div class="col-md-12">
                    <span style="font-size: 16px" class='vicon-{strtolower($RECORD->get('activitytype'))}'></span>
                    <span style="padding-left: 15px">
                        <strong style="font-size: 14px" title="{Vtiger_Util_Helper::formatDateTimeIntoDayString("$START_DATE $START_TIME")}">{Vtiger_Util_Helper::formatDateTimeIntoDayString("$START_DATE $START_TIME")}</strong><br />
