<?php /* Smarty version Smarty-3.1.7, created on 2017-09-26 01:03:43
         compiled from "C:\xampp\htdocs\vtiger7\vtigercrm\includes\runtime/../../layouts/v7\modules\Vtiger\EmailPreview.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1280159c9a76f6d3ff7-18996198%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3270bf108ed238194eea02e9a3e320ae38a8e6c2' => 
    array (
      0 => 'C:\\xampp\\htdocs\\vtiger7\\vtigercrm\\includes\\runtime/../../layouts/v7\\modules\\Vtiger\\EmailPreview.tpl',
      1 => 1496723290,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1280159c9a76f6d3ff7-18996198',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59c9a76f8530c',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59c9a76f8530c')) {function content_59c9a76f8530c($_smarty_tpl) {?>
...
</li><?php } ?></ul></span><?php }?></span></span></span></div></div><div class="col-lg-6"><div class="email-preview-toolbar pull-right"><?php if ($_smarty_tpl->tpl_vars['RECORD']->value->getEmailFlag()!='SAVED'&&$_smarty_tpl->tpl_vars['PARENT_MODULE']->value!='Cases'){?><button type="button" name="previewReply" class="btn btn-sm" data-mode="emailReply"><strong><?php echo vtranslate('LBL_REPLY',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></button><?php if (count($_smarty_tpl->tpl_vars['TO']->value)>1||!empty($_smarty_tpl->tpl_vars['CC']->value)||!empty($_smarty_tpl->tpl_vars['BCC']->value)){?><button type="button" name="previewReplyAll" class="btn btn-sm" data-mode="emailReplyAll"><strong><?php echo vtranslate('LBL_REPLY_ALL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></button><?php }?><?php }?><button type="button" name="previewForward" class="btn btn-sm" data-mode="emailForward"><strong><?php echo vtranslate('LBL_FORWARD',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></button><?php if ($_smarty_tpl->tpl_vars['RECORD']->value->getEmailFlag()=='SAVED'){?><button type="button" name="previewEdit" class="btn btn-sm" data-mode="emailEdit"><strong><?php echo vtranslate('LBL_EDIT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></button><?php }?><button type="button" name="previewPrint" class="btn btn-sm" data-mode="previewPrint"><strong><?php echo vtranslate('LBL_PRINT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></button></div></div></div><div class="row"><div class="col-lg-8"><?php if (!empty($_smarty_tpl->tpl_vars['CC']->value)){?><div class="row email-info-row"><span class="col-lg-12"><span class="col-lg-3"><span class="pull-right"><?php echo vtranslate('LBL_CC',$_smarty_tpl->tpl_vars['MODULE']->value);?>
