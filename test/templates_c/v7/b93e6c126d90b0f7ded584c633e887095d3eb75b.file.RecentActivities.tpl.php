<?php /* Smarty version Smarty-3.1.7, created on 2017-12-16 08:15:57
         compiled from "C:\xampp\htdocs\vtiger7\vtigercrm\includes\runtime/../../layouts/v7\modules\Vtiger\RecentActivities.tpl" */ ?>
<?php /*%%SmartyHeaderCode:275705a34d63deb5366-27469906%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b93e6c126d90b0f7ded584c633e887095d3eb75b' => 
    array (
      0 => 'C:\\xampp\\htdocs\\vtiger7\\vtigercrm\\includes\\runtime/../../layouts/v7\\modules\\Vtiger\\RecentActivities.tpl',
      1 => 1496723290,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '275705a34d63deb5366-27469906',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a34d63e1c567',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a34d63e1c567')) {function content_5a34d63e1c567($_smarty_tpl) {?>
...
"><?php echo Vtiger_Util_Helper::formatDateDiffInStrings($_smarty_tpl->tpl_vars['RELATION']->value->get('changedon'));?>
 </small></time><?php ob_start();?><?php echo strtolower($_smarty_tpl->tpl_vars['RELATED_MODULE']->value)=='modcomments';?>
<?php $_tmp4=ob_get_clean();?><?php if ($_tmp4){?><?php $_smarty_tpl->tpl_vars["VICON_MODULES"] = new Smarty_variable("vicon-chat", null, 0);?><?php }else{ ?><?php ob_start();?><?php echo strtolower($_smarty_tpl->tpl_vars['RELATED_MODULE']->value);?>
<?php $_tmp5=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["VICON_MODULES"] = new Smarty_variable("vicon-".$_tmp5, null, 0);?><?php }?><div class="update_icon  bg-info-<?php echo strtolower($_smarty_tpl->tpl_vars['RELATED_MODULE']->value);?>
"><i class="update_image <?php echo $_smarty_tpl->tpl_vars['VICON_MODULES']->value;?>
"></i></div><div class="update_info"><h5><?php $_smarty_tpl->tpl_vars['RELATION'] = new Smarty_variable($_smarty_tpl->tpl_vars['RECENT_ACTIVITY']->value->getRelationInstance(), null, 0);?><span class="field-name"><?php echo vtranslate($_smarty_tpl->tpl_vars['RELATION']->value->getLinkedRecord()->getModuleName(),$_smarty_tpl->tpl_vars['RELATION']->value->getLinkedRecord()->getModuleName());?>
