<?php /* Smarty version Smarty-3.1.7, created on 2017-06-30 05:15:45
         compiled from "C:\xampp\htdocs\vtiger7\vtigercrm\includes\runtime/../../layouts/v7\modules\Settings\ModuleManager\ImportUserModuleStep2.tpl" */ ?>
<?php /*%%SmartyHeaderCode:85825955de812e2586-74542853%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3495d498369e941fd11f417f83c9c0551face401' => 
    array (
      0 => 'C:\\xampp\\htdocs\\vtiger7\\vtigercrm\\includes\\runtime/../../layouts/v7\\modules\\Settings\\ModuleManager\\ImportUserModuleStep2.tpl',
      1 => 1496723290,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '85825955de812e2586-74542853',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5955de8141dad',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5955de8141dad')) {function content_5955de8141dad($_smarty_tpl) {?>
...
</small></p></div><?php $_smarty_tpl->tpl_vars["need_license_agreement"] = new Smarty_variable("false", null, 0);?><?php if ($_smarty_tpl->tpl_vars['MODULEIMPORT_LICENSE']->value){?><?php $_smarty_tpl->tpl_vars["need_license_agreement"] = new Smarty_variable("true", null, 0);?><div class="col-lg-12"><p><?php echo vtranslate('LBL_LICENSE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</p></div><div class="col-lg-12"><div style="background: #eee;padding: 20px;box-sizing: border-box;height: 150px;overflow-y: scroll;"><p><?php echo nl2br($_smarty_tpl->tpl_vars['MODULEIMPORT_LICENSE']->value);?>
</p></div></div><?php }?><br><div class="col-lg-12"><?php if ($_smarty_tpl->tpl_vars['MODULEIMPORT_EXISTS']->value!='true'){?><input type="checkbox" class="acceptLicense"> <?php echo vtranslate('LBL_LICENSE_ACCEPT_AGREEMENT',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
<?php }?>&nbsp;<?php if ($_smarty_tpl->tpl_vars['MODULEIMPORT_EXISTS']->value=='true'||$_smarty_tpl->tpl_vars['MODULEIMPORT_DIR_EXISTS']->value=='true'){?><?php if ($_smarty_tpl->tpl_vars['MODULEIMPORT_EXISTS']->value=='true'){?><input type="hidden" name="module_import_file" value="<?php echo $_smarty_tpl->tpl_vars['MODULEIMPORT_FILE']->value;?>
...
"><?php if ($_smarty_tpl->tpl_vars['need_license_agreement']->value=='true'){?><input type="checkbox" class="acceptLicense"> <?php echo vtranslate('LBL_LICENSE_ACCEPT_AGREEMENT',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
<?php }?><?php }else{ ?><br><br><span class="alert-info" style="padding: 4px 10px;"><?php echo vtranslate('LBL_DELETE_EXIST_DIRECTORY',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</span><?php }?><?php }else{ ?><input type="hidden" name="module_import_file" value="<?php echo $_smarty_tpl->tpl_vars['MODULEIMPORT_FILE']->value;?>
"><input type="hidden" name="module_import_type" value="<?php echo $_smarty_tpl->tpl_vars['MODULEIMPORT_TYPE']->value;?>
"><input type="hidden" name="module_import_name" value="<?php echo $_smarty_tpl->tpl_vars['MODULEIMPORT_NAME']->value;?>
