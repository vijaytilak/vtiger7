<?php /* Smarty version Smarty-3.1.7, created on 2017-07-06 09:03:26
         compiled from "C:\xampp\htdocs\vtiger7\vtigercrm\includes\runtime/../../layouts/v7\modules\Project\ShowChart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:28845595dfcde18f752-80991608%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fd22143bf56b5ec546ced79eea0d8824d3b4933d' => 
    array (
      0 => 'C:\\xampp\\htdocs\\vtiger7\\vtigercrm\\includes\\runtime/../../layouts/v7\\modules\\Project\\ShowChart.tpl',
      1 => 1498799088,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '28845595dfcde18f752-80991608',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_595dfcde260d7',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_595dfcde260d7')) {function content_595dfcde260d7($_smarty_tpl) {?>
...
<?php } ?></style><?php if (!empty($_smarty_tpl->tpl_vars['PROJECT_TASKS']->value['tasks'])){?><h3> <?php echo vtranslate('LBL_PROGRESS_CHART',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 </h3><div class="pull-right" style="margin-right: 5px;"><span style="margin: 2px;"><button class="btn textual zoomOut" title="zoom out"><span class="teamworkIcon">)</span></button></span><span style="margin: 2px;"><button class="btn textual zoomIn" title="zoom in"><span class="teamworkIcon">(</span></button></span><span style="margin: 2px;"><a href="index.php?module=Project&view=ExportChart&record=<?php echo $_smarty_tpl->tpl_vars['PARENT_ID']->value;?>
