<?php /* Smarty version Smarty-3.1.7, created on 2017-09-28 03:24:50
         compiled from "C:\xampp\htdocs\vtiger7\vtigercrm\includes\runtime/../../layouts/v7\modules\Potentials\SelectEmailFields.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2873759cc6b82ad6959-40514876%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c2fe5ada2e824a90cc6454b524434ae7f4ec7f5b' => 
    array (
      0 => 'C:\\xampp\\htdocs\\vtiger7\\vtigercrm\\includes\\runtime/../../layouts/v7\\modules\\Potentials\\SelectEmailFields.tpl',
      1 => 1496723290,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2873759cc6b82ad6959-40514876',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59cc6b82c99db',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59cc6b82c99db')) {function content_59cc6b82c99db($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include 'C:\\xampp\\htdocs\\vtiger7\\vtigercrm\\libraries\\Smarty\\libs\\plugins\\function.counter.php';
?>
...
" /><div id="multiEmailContainer" style="padding-left:20px;"><?php if ($_smarty_tpl->tpl_vars['EMAIL_FIELDS_INFO']->value){?><?php if ($_smarty_tpl->tpl_vars['RECORDS_COUNT']->value>1){?><input type="hidden" name="emailSource" value="ListView" /><?php echo smarty_function_counter(array('start'=>0,'skip'=>1,'assign'=>"count"),$_smarty_tpl);?>
<?php  $_smarty_tpl->tpl_vars['EMAIL_FIELDS_INFO'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['EMAIL_FIELDS_INFO']->_loop = false;
...
foreach ($_from as $_smarty_tpl->tpl_vars['EMAIL_FIELDS_INFO']->key => $_smarty_tpl->tpl_vars['EMAIL_FIELDS_INFO']->value){
$_smarty_tpl->tpl_vars['EMAIL_FIELDS_INFO']->_loop = true;
 $_smarty_tpl->tpl_vars['EMAIL_MODULE']->value = $_smarty_tpl->tpl_vars['EMAIL_FIELDS_INFO']->key;
...
" value='<?php echo Vtiger_Functions::jsonEncode(array('field'=>$_smarty_tpl->tpl_vars['EMAIL_FIELD_NAME']->value,'field_id'=>$_smarty_tpl->tpl_vars['EMAIL_FIELD']->value->getId(),'module_id'=>$_smarty_tpl->tpl_vars['EMAIL_FIELD']->value->getModule()->getId(),'basefield'=>$_smarty_tpl->tpl_vars['EMAIL_FIELD']->value->get('baseRefField')));?>
' <?php if ($_smarty_tpl->tpl_vars['EMAIL_FIELD']->value->get('isPreferred')){?>checked="true"<?php }?>/>&nbsp;<?php echo vtranslate($_smarty_tpl->tpl_vars['EMAIL_FIELD']->value->get('label'),$_smarty_tpl->tpl_vars['EMAIL_MODULE']->value);?>
</label><?php echo smarty_function_counter(array(),$_smarty_tpl);?>
<?php } ?><?php } ?><?php }else{ ?><?php echo smarty_function_counter(array('start'=>0,'skip'=>1,'assign'=>"count"),$_smarty_tpl);?>
<?php  $_smarty_tpl->tpl_vars['EMAIL_MODULE_INFO'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['EMAIL_MODULE_INFO']->_loop = false;
 $_smarty_tpl->tpl_vars['RECORD_ID'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['EMAIL_FIELDS_INFO']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['EMAIL_MODULE_INFO']->key => $_smarty_tpl->tpl_vars['EMAIL_MODULE_INFO']->value){
$_smarty_tpl->tpl_vars['EMAIL_MODULE_INFO']->_loop = true;
 $_smarty_tpl->tpl_vars['RECORD_ID']->value = $_smarty_tpl->tpl_vars['EMAIL_MODULE_INFO']->key;
?><?php ob_start();?><?php echo decode_html(textlength_check(Vtiger_Util_Helper::getRecordName($_smarty_tpl->tpl_vars['RECORD_ID']->value)));?>
<?php $_tmp2=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['RECORD_LABEL'] = new Smarty_variable($_tmp2, null, 0);?><?php if ($_smarty_tpl->tpl_vars['RECORDS_COUNT']->value>1){?><h4><?php echo $_smarty_tpl->tpl_vars['RECORD_LABEL']->value;?>
</h4><?php }?><div style="<?php if ($_smarty_tpl->tpl_vars['RECORDS_COUNT']->value>1){?>padding-left: 3%;<?php }?>"><?php  $_smarty_tpl->tpl_vars['EMAIL_FIELDS'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['EMAIL_FIELDS']->_loop = false;
 $_smarty_tpl->tpl_vars['EMAIL_MODULE'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['EMAIL_MODULE_INFO']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
$_smarty_tpl->tpl_vars['EMAIL_FIELDS']->_loop = true;
 $_smarty_tpl->tpl_vars['EMAIL_MODULE']->value = $_smarty_tpl->tpl_vars['EMAIL_FIELDS']->key;
?><h5><?php echo vtranslate(('SINGLE_').($_smarty_tpl->tpl_vars['EMAIL_MODULE']->value),$_smarty_tpl->tpl_vars['EMAIL_MODULE']->value);?>
</h5><?php  $_smarty_tpl->tpl_vars['EMAIL_FIELD'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['EMAIL_FIELD']->_loop = false;
