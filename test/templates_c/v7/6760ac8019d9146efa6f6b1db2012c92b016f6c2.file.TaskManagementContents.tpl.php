<?php /* Smarty version Smarty-3.1.7, created on 2017-06-30 05:09:53
         compiled from "C:\xampp\htdocs\vtiger7\vtigercrm\includes\runtime/../../layouts/v7\modules\Calendar\TaskManagementContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:191465955dd2104f570-71532962%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6760ac8019d9146efa6f6b1db2012c92b016f6c2' => 
    array (
      0 => 'C:\\xampp\\htdocs\\vtiger7\\vtigercrm\\includes\\runtime/../../layouts/v7\\modules\\Calendar\\TaskManagementContents.tpl',
      1 => 1496723290,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '191465955dd2104f570-71532962',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5955dd211cc51',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5955dd211cc51')) {function content_5955dd211cc51($_smarty_tpl) {?>
...
</span></span><?php $_smarty_tpl->tpl_vars['RELATED_PARENT'] = new Smarty_variable($_smarty_tpl->tpl_vars['RECORD_BASIC_INFO']->value['parent_id'], null, 0);?><?php $_smarty_tpl->tpl_vars['RELATED_CONTACT'] = new Smarty_variable($_smarty_tpl->tpl_vars['RECORD_BASIC_INFO']->value['contact_id'], null, 0);?><?php if (!empty($_smarty_tpl->tpl_vars['RELATED_PARENT']->value)){?><span class='related_account' style='margin-left: 8px;'><?php $_smarty_tpl->tpl_vars['RELATED_PARENT_MODULE'] = new Smarty_variable($_smarty_tpl->tpl_vars['RELATED_PARENT']->value['module'], null, 0);?><i class="vicon-<?php echo mb_strtolower($_smarty_tpl->tpl_vars['RELATED_PARENT_MODULE']->value, 'UTF-8');?>
" style="font-size: 12px;"></i>&nbsp;<span class="recordName textOverflowEllipsis" style="vertical-align: middle"><a class="quickPreview" href="index.php?module=<?php echo $_smarty_tpl->tpl_vars['RELATED_PARENT_MODULE']->value;?>
...
</a></span></span><?php }?><?php if (!empty($_smarty_tpl->tpl_vars['RELATED_CONTACT']->value['id'])){?><span class='related_contact' style='margin-left: 8px;'><i class="vicon-contacts" style="font-size: 12px;"></i>&nbsp;<span class="recordName textOverflowEllipsis" style="vertical-align: middle"><a class="quickPreview" href="index.php?module=<?php echo $_smarty_tpl->tpl_vars['RELATED_CONTACT']->value['module'];?>
