<?php /* Smarty version Smarty-3.1.7, created on 2017-06-30 05:43:22
         compiled from "C:\xampp\htdocs\vtiger7\vtigercrm\includes\runtime/../../layouts/v7\modules\VTEReports\partials\SidebarEssentials.tpl" */ ?>
<?php /*%%SmartyHeaderCode:174495955e4fa4b7bc0-13043308%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '51eab755f34e19a34e1bd035604172076d886374' => 
    array (
      0 => 'C:\\xampp\\htdocs\\vtiger7\\vtigercrm\\includes\\runtime/../../layouts/v7\\modules\\VTEReports\\partials\\SidebarEssentials.tpl',
      1 => 1498801373,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '174495955e4fa4b7bc0-13043308',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5955e4fa51179',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5955e4fa51179')) {function content_5955e4fa51179($_smarty_tpl) {?>
...
</h5></div><hr><div><input class="search-list" type="text" placeholder="<?php echo vtranslate('Search folder',$_smarty_tpl->tpl_vars['MODULE']->value);?>
"></div><div class="menu-scroller mCustomScrollBox" data-mcs-theme="dark"><div class="mCustomScrollBox mCS-light-2 mCSB_inside" tabindex="0"><div class="mCSB_container" style="position:relative; top:0; left:0;"><div class="list-menu-content"><div class="list-group"><ul class="lists-menu"><li style="font-size:12px;" class="listViewFilter" ><a href="#" class='filterName vteViewByFolder' data-filter-id="All"><i class="fa fa-folder foldericon"></i>&nbsp;<?php echo vtranslate('LBL_ALL_REPORTS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['VIEWNAME'] = new Smarty_variable($_tmp1, null, 0);?><a href="#" class='filterName vteViewByFolder' data-filter-id=<?php echo $_smarty_tpl->tpl_vars['FOLDER']->value->getId();?>
...
" data-toggle="dropdown" aria-expanded="true"></span></span></div></li><?php } ?></ul><div id="filterActionPopoverHtml"><ul class="listmenu hide" role="menu"><li role="presentation" class="editFilter"><a role="menuitem"><i class="fa fa-pencil-square-o"></i>&nbsp;<?php echo vtranslate('LBL_EDIT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
