<?php /* Smarty version Smarty-3.1.7, created on 2017-12-19 04:09:49
         compiled from "C:\xampp\htdocs\vtiger7\vtigercrm\includes\runtime/../../layouts/v7\modules\Vtiger\RecentComments.tpl" */ ?>
<?php /*%%SmartyHeaderCode:242965a38910d4e5101-82970688%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '46035e4f379fbf9e7cbfaa84bba13ee604fe4365' => 
    array (
      0 => 'C:\\xampp\\htdocs\\vtiger7\\vtigercrm\\includes\\runtime/../../layouts/v7\\modules\\Vtiger\\RecentComments.tpl',
      1 => 1496723290,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '242965a38910d4e5101-82970688',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a38910d7435e',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a38910d7435e')) {function content_5a38910d7435e($_smarty_tpl) {?>
...
</small></span><div class=""><?php if ($_smarty_tpl->tpl_vars['COMMENT']->value->get('module')=='Cases'&&!$_smarty_tpl->tpl_vars['COMMENT']->value->get('is_private')){?><?php ob_start();?><?php echo decode_html($_smarty_tpl->tpl_vars['COMMENT']->value->get('commentcontent'));?>
<?php $_tmp2=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['COMMENT_CONTENT'] = new Smarty_variable($_tmp2, null, 0);?><?php }else{ ?><?php ob_start();?><?php echo nl2br($_smarty_tpl->tpl_vars['COMMENT']->value->get('commentcontent'));?>
<?php $_tmp3=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['COMMENT_CONTENT'] = new Smarty_variable($_tmp3, null, 0);?><?php }?><?php if ($_smarty_tpl->tpl_vars['COMMENT_CONTENT']->value){?><?php ob_start();?><?php echo decode_html($_smarty_tpl->tpl_vars['COMMENT_CONTENT']->value);?>
<?php $_tmp4=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['DISPLAYNAME'] = new Smarty_variable($_tmp4, null, 0);?><span class="commentInfoContent" style="display: block" data-fullComment="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['COMMENT_CONTENT']->value, ENT_QUOTES, 'UTF-8', true);?>
...
'><?php if (mb_strlen($_smarty_tpl->tpl_vars['DISPLAYNAME']->value, 'UTF-8')>200){?><?php echo mb_substr(trim($_smarty_tpl->tpl_vars['DISPLAYNAME']->value),0,200);?>
...<br><a class="pull-right toggleComment showMore"><small><?php echo vtranslate('LBL_SHOW_MORE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</a><?php }?></span></div><br><div class="row commentEditStatus marginBottom10px" name="editStatus"><?php $_smarty_tpl->tpl_vars["REASON_TO_EDIT"] = new Smarty_variable($_smarty_tpl->tpl_vars['COMMENT']->value->get('reasontoedit'), null, 0);?><span class="col-lg-5 col-md-5 col-sm-5<?php if (empty($_smarty_tpl->tpl_vars['REASON_TO_EDIT']->value)){?> hide<?php }?>"><small> [<?php echo vtranslate('LBL_EDIT_REASON',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
]</small></span><?php if ($_smarty_tpl->tpl_vars['COMMENT']->value->getCommentedTime()!=$_smarty_tpl->tpl_vars['COMMENT']->value->getModifiedTime()){?><span class="<?php if (empty($_smarty_tpl->tpl_vars['REASON_TO_EDIT']->value)){?>row<?php }else{ ?> col-lg-7 col-md-7 col-sm-7<?php }?>"><p class="text-muted pull-right"><small><em><?php echo vtranslate('LBL_MODIFIED',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
...
</small></p></span><?php }?></div><div class="row marginBottom10px"><div class="col-lg-12 col-md-12 col-sm-12"><p class="text-muted"><small><span name="editReason" class="wordbreak"><?php echo nl2br($_smarty_tpl->tpl_vars['REASON_TO_EDIT']->value);?>
</span></small></p></div></div></div></div></div></div></div></div></div><?php if ($_smarty_tpl->tpl_vars['index']->value+1!=$_smarty_tpl->tpl_vars['COMMENTS_COUNT']->value){?><hr style="margin-top:0; margin-bottom: 10px;"><?php }?><?php } ?></div><?php }else{ ?><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("NoComments.tpl"), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
<?php }?><?php if ($_smarty_tpl->tpl_vars['PAGING_MODEL']->value->isNextPageExists()){?><div class="row"><div class="textAlignCenter"><a href="javascript:void(0)" class="moreRecentComments"><?php echo vtranslate('LBL_SHOW_MORE',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</a></div></div><?php }?></div><div class="hide basicAddCommentBlock container-fluid"><div class="commentTextArea row"><textarea name="commentcontent" class="commentcontent" placeholder="<?php echo vtranslate('LBL_ADD_YOUR_COMMENT_HERE',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
" rows="<?php echo $_smarty_tpl->tpl_vars['COMMENT_TEXTAREA_DEFAULT_ROWS']->value;?>
...
" class="input-block-level"/></div><div class="row" style="padding-bottom: 10px;"><div class="commentTextArea"><textarea name="commentcontent" class="commentcontenthidden" placeholder="<?php echo vtranslate('LBL_ADD_YOUR_COMMENT_HERE',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
" rows="<?php echo $_smarty_tpl->tpl_vars['COMMENT_TEXTAREA_DEFAULT_ROWS']->value;?>
