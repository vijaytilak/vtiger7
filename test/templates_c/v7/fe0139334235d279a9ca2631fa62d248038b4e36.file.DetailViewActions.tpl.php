...
<?php /*%%SmartyHeaderCode:307895a389109202773-47204488%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '307895a389109202773-47204488',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a38910928274',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a38910928274')) {function content_5a38910928274($_smarty_tpl) {?>
...
&app=<?php echo $_smarty_tpl->tpl_vars['SELECTED_MENU_CATEGORY']->value;?>
'" <?php }?>><i class="fa fa-chevron-right"></i></button></div><?php }?></div><div style="border: 1px solid red; height: 100%">ssdsd</div><input type="hidden" name="record_id" value="<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->getId();?>
"></div><?php }} ?>