...
class Potentials_Module_Model extends Vtiger_Module_Model {
    ...
    //Vijay - Added the below function
	/**
	...
	function getCalendarActivities($mode, $pagingModel, $user, $recordId = false) {
		...
		$query .= " WHERE vtiger_crmentity.deleted=0
					...
					AND (vtiger_activity.eventstatus is NULL OR vtiger_activity.eventstatus NOT IN ('Held','Cancelled','Not Held','Rescheduled'))";
	 ...
	 * @return <Array>
	 */
	function getAllCalendarActivities($mode, $pagingModel, $user, $recordId = false) {
		$currentUser = Users_Record_Model::getCurrentUserModel();
		$db = PearDatabase::getInstance();
