...
class Events_SaveAjax_Action extends Events_Save_Action {
	...
	public function process(Vtiger_Request $request) {
		...
		//Vijay
		$result['contact_id'] = $request->get('contact_id');
	...
	public function getRecordModelFromRequest(Vtiger_Request $request) {
		...
		//Vijay : Link Contact To Events On Save
		$contact_id = $request->get('contact_id');
		$recordModel->set('contact_id', $contact_id);

//		$contactName = getContactName($contact_id);
//		$contactLastName = end(explode( ' ', $contactName));
//		$subject = $contactLastName.' - '.$recordModel->get('subject');
